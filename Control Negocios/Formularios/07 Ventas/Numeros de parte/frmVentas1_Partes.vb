...
kaka:
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText =
                        "select Status_Promocion,Grupo,Departamento,Codigo,Nombre,UVenta,Multiplo,Min,Ubicacion from Productos where N_Serie='" & cbodesc.Text & "' OR N_Serie2='" & cbodesc.Text & "'"
                rd1 = cmd1.ExecuteReader
                If rd1.HasRows Then
                    If rd1.Read Then
