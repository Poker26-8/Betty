...
Public Class frmVentas2
    ...
    Private Async Sub frmVentas2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim Sql As String = "select * from Productos where Grupo<>'INSUMO' and ProvRes<>1 order by Nombre"
        Dim dr As DataRow
        With odata
            If .dbOpen(cnn_c, sTargetlocal, sInfo) Then
                If .getDt(cnn_c, dt, Sql, sInfo) Then
                    ...
                    If cbocodigo.Text <> "" Then
                        ...
                        If rd2.HasRows Then
                            If rd2.Read Then
                                ...
                                Promo = IIf(DataGridView1.Rows(index).Cells("PrecioVentaIVA").Value.ToString = False, False, True)
                                Anti = DataGridView1.Rows(index).Cells("Grupo").Value.ToString
