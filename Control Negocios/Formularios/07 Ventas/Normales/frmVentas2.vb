...
#Region "Funciones"
    ...
    Private Sub UpGrid()
        ...
        'Dim cnn3 As MySqlConnection = New MySqlConnection(sTargetlocalmysql)
        'Dim cnn1 As MySqlConnection = New MySqlConnection(sTargetlocalmysql)
        'Dim rd3, rd1 As MySqlDataReader
        'Dim cmd3, cmd1 As MySqlCommand
        ...
        Try
            ...
            If rd1.HasRows Then
                ...
                "select NumPart,NotasCred from Formatos where Facturas='Porc_Mone'"
                        ...
                        cmd2.CommandText = "select Saldo from Monedero WHERE Barras='" & txttel.Text & "'"
                        rd2 = cmd2.ExecuteReader
                        If rd2.HasRows Then
                            If rd2.Read Then
                                sal_monedero = IIf(rd2(0).ToString = "", 0, rd2(0).ToString)
                            End If
                        End If
                        rd2.Close()
                        cnn2.Close()
        ...
        If AscW(e.KeyChar) = Keys.Enter And (cbocodigo.Text <> "" Or cbodesc.Text <> "") Then
            ...
            If cbocodigo.Text <> "" Then
                Try
                    ...
                    If index2 <> -1 Then
                        txtexistencia.Text = FormatNumber(CDbl(IIf(DataGridView1.Rows(index).Cells("Existencia").Value.ToString() = "", "0", DataGridView1.Rows(index).Cells("Existencia").Value.ToString())) / Multiplo, 2)
                    End If
...
Door:
    ...
    Public Sub PDF_Cotizacion()
        ...
        If DesglosaIVA = "1" Then
            ...
            If IVA_Vent > 0 Then
                If IVA_Vent > 0 And IVA_Vent <> CDbl(txtPagar.Text) Then
                    FileNta.DataDefinition.FormulaFields("IVA").Text = "'" & FormatNumber(IVA_Vent, 2) & "'"   'IVA
                End If
            End If
        End If
    ...
    Private Sub btnventa_Click(sender As System.Object, e As System.EventArgs) Handles btnventa.Click
        ...
        Dim cnn3 As MySqlConnection = New MySqlConnection(sTargetlocalmysql)
        Dim cnn5 As MySqlConnection = New MySqlConnection(sTargetlocalmysql)
        Dim rd1, rd2, rd3, rd5 As MySqlDataReader
        Dim cmd1, cmd2, cmd3, cmd5 As MySqlCommand
...
kakaxd:
        ...
        Try
            ...
            If lblNumCliente.Text <> "MOSTRADOR" Then
                ...
                If MySaldo = 0 Then
                    MySaldo = MySaldo = txtPagar.Text
                Else
                    MySaldo = CDbl(MySaldo) + CDbl(txtPagar.Text)
                End If
...
doorcita:
    ...
    Public Sub FiltrarDataGridView(ByVal filtro As String, ByVal columna As Integer)
        ...
        For Each fila As DataGridViewRow In DataGridView1.Rows
            Try
                ...
                If fila.Cells(columna).Value IsNot Nothing AndAlso
                   fila.Cells(columna).Value.ToString().ToLower().Contains(filtro.ToLower()) Then
                    fila.Visible = True
                Else
                    fila.Visible = False
                End If
            Catch ex As Exception
                ' fila.Visible = False ' Ocultar filas con errores
            End Try
        Next
    End Sub
