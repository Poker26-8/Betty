    ...
    Private Sub OK_Click(sender As System.Object, e As System.EventArgs) Handles OK.Click
        ...
        Try
            ...
            If txtRuta.Text <> "" Then
                ...
                sTargetlocalmysql = "server=" & txtRuta.Text & ";uid=Delsscom;password=jipl22;database=cn" & base & ";persist security info=false;connect timeout=300"
            ...
            Else
                ...
                sTargetlocalmysql = "server=" & MyIP & ";uid=Delsscom;password=jipl22;database=cn" & base & ";persist security info=false;connect timeout=300"
                ...
                Try
                    ...
                    With odata
                        If .dbOpen(cnnprueba, sTargetprueba, sinfo) Then
                            ...
                            .runSp(cnnprueba, VarAutoproduccion, sinfo)
                            ...
                            .runSp(cnnprueba, VarAutomovimiento, sinfo)

                            'autoriza
                            .runSp(cnnprueba, vartablaautoriza, sinfo)
                            .runSp(cnnprueba, VarKeyautoriza, sinfo)
                            .runSp(cnnprueba, VarAutoautoriza, sinfo)

                            'bodegas
                            .runSp(cnnprueba, vartablabodegas, sinfo)
                            .runSp(cnnprueba, VarKeybodegas, sinfo)
                            .runSp(cnnprueba, VarAutobodegas, sinfo)
                            ...
                            .runSp(cnnprueba, VarAutoreservaciones, sinfo)
