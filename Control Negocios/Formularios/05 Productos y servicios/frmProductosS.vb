        ...
        Try
            ...
            If rd1.HasRows Then
                If rd1.Read Then
                    ...
                    txtpcompra.Text = FormatNumber(rd1("PrecioCompra").ToString() / (1 + CDbl(cboIVA.Text)), 2)
        ...
        Try
            ...
            If rd2.HasRows Then
                If rd2.Read Then
                    ...
                    txtpcompra.Text = FormatNumber(rd2("PrecioCompra").ToString() / (1 + CDbl(cboIVA.Text)), 2)
                    txtpcompra2.Text = FormatNumber(CDbl(txtpcompra.Text) * (1 + CDbl(cboIVA.Text)), 2)
