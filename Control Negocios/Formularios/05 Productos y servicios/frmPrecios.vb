            ...
            Else
                ...
                If rd1.HasRows Then
                    If rd1.Read Then
                        ...
                        TxtPC.Text = FormatNumber((rd1("PrecioCompra").ToString() / 1.16) * LblValor.Text, 2)
