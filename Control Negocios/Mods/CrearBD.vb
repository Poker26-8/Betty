Module CrearBD
    ...
    Public vartablahisclinica As String = "CREATE TABLE `hisclinica` (
                                                  ...
                                                  `Folio` int(11) NOT NULL DEFAULT '0',
                                                  `Padecimiento` varchar(255) DEFAULT '',
                                                  `Urgencia` varchar(100) DEFAULT '',
                                                  `Tutor` varchar(255) DEFAULT '',
                                                  `FNacimiento` date DEFAULT NULL,
                                                  `Estado` int(11) DEFAULT '0',
                                                  `MSC` double DEFAULT '0',
...
"
    ...
    'AbonoI
    Public vartablaabonoi As String = "CREATE TABLE `abonoi` (
                                          `Id` int(11) NOT NULL,
                                          ...
                                          `Comisiones` double NOT NULL DEFAULT '0',
                                          ...
                                          `CorteU` int(1) NOT NULL DEFAULT '0',
                                          `Cargado` int(1) NOT NULL DEFAULT '0',
                                          `MontoSF` double NOT NULL DEFAULT '0',
                                          ...
                                          `Status` int(11) DEFAULT '0',
                                          `Parcialidad` varchar(100) DEFAULT ''
                                        ) ENGINE=InnoDB DEFAULT CHARSET=latin1;"
    ...
    'Parcialidades
    Public vartablaparcialidades As String = "CREATE TABLE `parcialidades` (
                                                  `Id` int(11) NOT NULL,
                                                  ...
                                                  `CPCli` varchar(100) DEFAULT '',
                                                  `CliRegimen` varchar(100) DEFAULT '',
                                                  `BaseIVA16` varchar(100) DEFAULT '',
                                                  `BaseIVA0` varchar(100) DEFAULT '',
                                                  `BaseIVARet` varchar(100) DEFAULT ''
                                                ) ENGINE=InnoDB DEFAULT CHARSET=latin1;"
...
(1, 'ADMINISTRADOR', 'ADMIN', 'ADMINISTRACIÓN', 'ADMINISTRACIÓN', '', '', '', '', '1', '2023-07-28', 0, 0, 0, '', '', '', '', '', '0', '0', '', '', '', '1', 1, '', 0, 1, '', '', '', '', '', '', '', '', '', '');"
    ...
    Public vartablaventas As String = "CREATE TABLE IF NOT EXISTS `ventas` (
                                          ...
                                          `Subtotal` double NOT NULL DEFAULT '0',
                                          `IVA` double NOT NULL DEFAULT '0',
                                          `Totales` double NOT NULL DEFAULT '0',
                                          `Propina` double NOT NULL DEFAULT '0',
                                          `Descuento` double NOT NULL DEFAULT '0',
                                          `Devolucion` double NOT NULL DEFAULT '0',
                                          `ACuenta` double NOT NULL DEFAULT '0',
                                          ...
                                          `MontoCance` double NOT NULL DEFAULT '0',
                                          `Status` varchar(50) NOT NULL DEFAULT '',
                                          `Comisionista` varchar(80) NOT NULL DEFAULT '',
                                          ...
                                          `Comentario` varchar(255) NOT NULL DEFAULT '',
                                          `CantidadE` double NOT NULL DEFAULT '0',
                                          ...
                                          `MntoCortesia` double NOT NULL DEFAULT '0',
                                          ...
                                          `Fecha` datetime NOT NULL,
                                          `Consignar` int(11) DEFAULT '0',
                                          `Mesero` varchar(150) DEFAULT ''
                                        ) ENGINE=InnoDB DEFAULT CHARSET=latin1;"
    ...
    Public vartablaventasdetalle As String = "CREATE TABLE IF NOT EXISTS `ventasdetalle` (
                                                  ...
                                                  `Unidad` varchar(50) NOT NULL DEFAULT '',
                                                  `Cantidad` double NOT NULL DEFAULT '0',
                                                  `CostoVP` double NOT NULL DEFAULT '0',
                                                  `CostoVUE` double NOT NULL DEFAULT '0',
                                                  `Precio` double NOT NULL DEFAULT '0',
                                                  `Total` double NOT NULL DEFAULT '0',
                                                  ...
                                                  `Descto` double NOT NULL DEFAULT '0',
                                                  `VDCosteo` double NOT NULL DEFAULT '0',
                                                  `TotalIEPS` double NOT NULL DEFAULT '0',
                                                  `TasaIEPS` double NOT NULL DEFAULT '0',
                                                  `Caducidad` varchar(80) NOT NULL DEFAULT '',
                                                  `Lote` varchar(100) NOT NULL DEFAULT '',
                                                  `CantidadE` double NOT NULL DEFAULT '0',
                                                  `Promo_Monedero` double NOT NULL DEFAULT '0',
                                                  `Unico` int(1) NOT NULL DEFAULT '0',
                                                  ...
                                                  `CantidadC` int(11) DEFAULT '0',
                                                  `CodUnico` varchar(255) DEFAULT '',
                                                  `Antibiotico` int(11) DEFAULT '0',
                                                  `Controlado` int(11) DEFAULT '0',
                                                  `Mesero` varchar(70) DEFAULT ''
                                                ) ENGINE=InnoDB DEFAULT CHARSET=latin1;"
